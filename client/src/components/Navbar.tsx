...
const Navbar = ({ onMenuClick }: NavbarProps) => {
    ...
    return (
        <nav className="sticky top-0 z-50 bg-white/95 md:bg-white/80 dark:bg-gray-900/95 md:dark:bg-gray-900/80 backdrop-blur-md shadow-sm dark:shadow-gray-900/50 border-b border-gray-200 dark:border-gray-800 transition-all duration-300">
